...
SECRET_KEY = 'django-insecure-+=3arrp(wgz5)eu-2b!f=o+un=wd)@ra4g5*z6vwz%12ujq6(l'
...
INSTALLED_APPS = [
    'connectionMqtt.apps.ConnectionmqttConfig',
    'settingMqtt.apps.SettingmqttConfig',
...
# STATICFILES_DIRS = [
#     'mqttDjango/static', 'settingMqtt/static', 'connectionMqtt/static' 
# ]
